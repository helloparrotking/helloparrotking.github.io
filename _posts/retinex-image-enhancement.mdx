...
In the previous blog about [Retinex theory](https://helloparrotking.github.io/blog/retinex-theory-of-color-vision), we derived an equation that, the color of an image/scene that we perceive is equal to the illumination on the scene product the reflectance of the scene. When we formulate the previous statement in equation form, that gives
...
- [Retinex Theory of Color Vision](https://helloparrotking.github.io/blog/retinex-theory-of-color-vision)
